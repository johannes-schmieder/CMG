...
new_workflow = 'WORKFLOW = Path(".github/workflows/direct-compact-forest-labels-v5.yml")'
...
new_script = 'SCRIPT = Path("scripts/direct_compact_forest_labels_gate_v5.py")'
...
required = (
    "direct_compact_forest_labels_gate_v5.py",
    "direct-compact-forest-labels-v5.yml",
    "impl PartialEq<&[usize]> for ForestAggregationLabels",
